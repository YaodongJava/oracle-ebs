...
> 现金管理、银行对账、Oracle Payments 边界、资金管理与 E-Business Tax。本文件由原目录中的 17 份资料合并而成；各章节保留原来源标记，便于审计与后续去重。

## 本模块章节导航

- [Cash, Treasury and Tax](#src-docs-06-cash-tax-readme)（原 `docs/06-cash-tax/README.md`）
- [Cash, Treasury and Tax： bank-account-transfer-and-pooling](#src-docs-06-cash-tax-bank-account-transfer-and-pooling-readme)（原 `docs/06-cash-tax/bank-account-transfer-and-pooling/README.md`）
- [Cash, Treasury and Tax： bank-statement-integration](#src-docs-06-cash-tax-bank-statement-integration-readme)（原 `docs/06-cash-tax/bank-statement-integration/README.md`）
- [Cash, Treasury and Tax： cash-management](#src-docs-06-cash-tax-cash-management-readme)（原 `docs/06-cash-tax/cash-management/README.md`）
- [Cash, Treasury and Tax： cash-position-and-forecast](#src-docs-06-cash-tax-cash-position-and-forecast-readme)（原 `docs/06-cash-tax/cash-position-and-forecast/README.md`）
- [Cash, Treasury and Tax： e-business-tax](#src-docs-06-cash-tax-e-business-tax-readme)（原 `docs/06-cash-tax/e-business-tax/README.md`）
- [Cash, Treasury and Tax： tax-engines-and-external-services](#src-docs-06-cash-tax-tax-engines-and-external-services-readme)（原 `docs/06-cash-tax/tax-engines-and-external-services/README.md`）
- [Cash, Treasury and Tax： tax-reporting-ledger](#src-docs-06-cash-tax-tax-reporting-ledger-readme)（原 `docs/06-cash-tax/tax-reporting-ledger/README.md`）
- [Cash, Treasury and Tax： treasury](#src-docs-06-cash-tax-treasury-readme)（原 `docs/06-cash-tax/treasury/README.md`）
- [现金管理、付款与税务（CE / IBY / EBTax）](#src-docs-07-ce-tax-readme)（原 `docs/07-ce-tax/README.md`）
- [付款/收款清算、现金预测与银行接口](#src-docs-07-ce-tax-cash-forecast-interfaces)（原 `docs/07-ce-tax/cash-forecast-interfaces.md`）
- [现金管理：银行、银行账户、对账单与自动核对](#src-docs-07-ce-tax-cash-management)（原 `docs/07-ce-tax/cash-management.md`）
- [Oracle E-Business Tax（EBTax）税种、税率、规则与排错](#src-docs-07-ce-tax-ebtax)（原 `docs/07-ce-tax/ebtax.md`）
- [Oracle Cash Management、Payments 与 E-Business Tax 接口实现案例](#src-docs-07-ce-tax-interfaces)（原 `docs/07-ce-tax/interfaces.md`）
- [Cash Management / Payments / EBTax 常用表结构](#src-docs-07-ce-tax-tables)（原 `docs/07-ce-tax/tables.md`）
- [EBTax 税务报告、本地化与合规控制](#src-docs-07-ce-tax-tax-reporting-localization)（原 `docs/07-ce-tax/tax-reporting-localization.md`）
- [Treasury、现金头寸与银行主数据治理](#src-docs-07-ce-tax-treasury-bank-governance)（原 `docs/07-ce-tax/treasury-bank-governance.md`）

---

<!-- source: docs/06-cash-tax/README.md -->
...
### 与既有知识的关系
本目标目录新增详细入口；已有专题保留在 [07-ce-tax/README](#src-docs-07-ce-tax-readme) 并逐步迁移链接，不复制历史内容。
...
<!-- source: docs/06-cash-tax/bank-account-transfer-and-pooling/README.md -->
<a id="src-docs-06-cash-tax-bank-account-transfer-and-pooling-readme"></a>
## Cash, Treasury and Tax： bank-account-transfer-and-pooling


<a id="src-docs-06-cash-tax-bank-account-transfer-and-pooling-readme--业务定位"></a>
### 业务定位
本专题是 Cash, Treasury and Tax 中的 bank-account-transfer-and-pooling 子域。覆盖现金管理、Treasury、EBTax、Tax Reporting Ledger、银行对账单、现金预测、资金归集和外部税引擎。
...
### 关联与官方依据
[本知识域入口](#src-docs-06-cash-tax-readme)｜[Oracle Financials Documentation](https://docs.oracle.com/cd/E26401_01/nav/financials.htm)


<!-- source: docs/06-cash-tax/bank-statement-integration/README.md -->
...
<!-- source: docs/06-cash-tax/cash-management/README.md -->
<a id="src-docs-06-cash-tax-cash-management-readme"></a>
## Cash, Treasury and Tax： cash-management


<a id="src-docs-06-cash-tax-cash-management-readme--业务定位"></a>
### 业务定位
本专题是 Cash, Treasury and Tax 中的 cash-management 子域。覆盖现金管理、Treasury、EBTax、Tax Reporting Ledger、银行对账单、现金预测、资金归集和外部税引擎。
...
<!-- source: docs/06-cash-tax/cash-position-and-forecast/README.md -->
<a id="src-docs-06-cash-tax-cash-position-and-forecast-readme"></a>
## Cash, Treasury and Tax： cash-position-and-forecast


<a id="src-docs-06-cash-tax-cash-position-and-forecast-readme--业务定位"></a>
### 业务定位
本专题是 Cash, Treasury and Tax 中的 cash-position-and-forecast 子域。覆盖现金管理、Treasury、EBTax、Tax Reporting Ledger、银行对账单、现金预测、资金归集和外部税引擎。
...
<!-- source: docs/06-cash-tax/e-business-tax/README.md -->
<a id="src-docs-06-cash-tax-e-business-tax-readme"></a>
## Cash, Treasury and Tax： e-business-tax


<a id="src-docs-06-cash-tax-e-business-tax-readme--业务定位"></a>
### 业务定位
本专题是 Cash, Treasury and Tax 中的 e-business-tax 子域。覆盖现金管理、Treasury、EBTax、Tax Reporting Ledger、银行对账单、现金预测、资金归集和外部税引擎。
...
<!-- source: docs/06-cash-tax/tax-engines-and-external-services/README.md -->
<a id="src-docs-06-cash-tax-tax-engines-and-external-services-readme"></a>
## Cash, Treasury and Tax： tax-engines-and-external-services


<a id="src-docs-06-cash-tax-tax-engines-and-external-services-readme--业务定位"></a>
### 业务定位
本专题是 Cash, Treasury and Tax 中的 tax-engines-and-external-services 子域。覆盖现金管理、Treasury、EBTax、Tax Reporting Ledger、银行对账单、现金预测、资金归集和外部税引擎。
...
<!-- source: docs/06-cash-tax/tax-reporting-ledger/README.md -->
<a id="src-docs-06-cash-tax-tax-reporting-ledger-readme"></a>
## Cash, Treasury and Tax： tax-reporting-ledger


<a id="src-docs-06-cash-tax-tax-reporting-ledger-readme--业务定位"></a>
### 业务定位
本专题是 Cash, Treasury and Tax 中的 tax-reporting-ledger 子域。覆盖现金管理、Treasury、EBTax、Tax Reporting Ledger、银行对账单、现金预测、资金归集和外部税引擎。
...
<!-- source: docs/06-cash-tax/treasury/README.md -->
<a id="src-docs-06-cash-tax-treasury-readme"></a>
## Cash, Treasury and Tax： treasury


<a id="src-docs-06-cash-tax-treasury-readme--业务定位"></a>
### 业务定位
本专题是 Cash, Treasury and Tax 中的 treasury 子域。覆盖现金管理、Treasury、EBTax、Tax Reporting Ledger、银行对账单、现金预测、资金归集和外部税引擎。
